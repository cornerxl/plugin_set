 ...
 */
;(function() {
    var plugin_01002 = function() {};

    plugin_01002.prototype = {
        init: function(view) {
            var me = this;
        ...
        render:function(view){
            ...
            data.data.page.all_page=100;
            if(data.data.page.all_page >= 0) {
                // 动态修改页码数组
                if(data.data.page.all_page > 7) {
                    data.data.page.page_rows = [];
                    for(var i = 1; i < 7; i ++) {
                        if(i === 6) {
                            data.data.page.page_rows.push({
                                page: '...',
                                pre_page: data.data.page.pre_page
                            });
                        }else {
                            data.data.page.page_rows.push({
                                page: i,
            ...
            setTimeout(function () {
                ...
                new DD.Event({
                    ...
                    handler:function(e,d,v){
                        var me = this;
                        if(data.data.page.pre_page === 1) {
                            return;
                        }
                        data.pre_page --;
                        changePageRows(data.data.page.pre_page, data.data.page.all_page);
                        // 请求数据
                ...
                new DD.Event({
                    ...
                    handler:function(e,d,v){
                        var me = this;
                        if(data.data.page.pre_page === data.data.page.all_page) {
                            return;
                        }
                        data.pre_page ++;
                        changePageRows(data.data.page.pre_page, data.data.page.all_page);
                ...
                new DD.Event({
                    ...
                    handler:function(e,d,v){
                        var me = this;
                        if(parseInt(data.data.page.go_page) > data.data.page.all_page) {
                            return;
                        }
                        data.data.page.pre_page = parseInt(data.data.page.go_page);
                        changePageRows(data.data.page.pre_page, data.data.page.all_page);
                        // 请求数据
                        // this.module.methodFactory.methods.updatePage.call(this);
                        view.$forceRender = true;
                ...
                for(let i = 0; i < page_arr.length; i ++) {
                    new DD.Event({
                        ...
                        handler:function(e,d,v){
                            if(d.page !== '...') {
                                data.data.page.pre_page = d.page;
                                changePageRows(data.data.page.pre_page, data.data.page.all_page);
                                // 请求数据
                                // this.module.methodFactory.methods.updatePage.call(this);
                                view.$forceRender = true;
    ...
    DD.Plugin.create('plugin_01002', plugin_01002);
}());